    ...
    fetch(jsonUrl)
        ...
        .then(productsData => {
            ...
            productsData.forEach(function(productData) {
                ...
                aElement.setAttribute('href', 'product.html');
                ...
                imgElement.setAttribute('src', productData.attachments);
                imgElement.setAttribute('alt', productData.name);
                ...
                h5Element.textContent = productData.name;
                ...
                pElement.textContent = productData.short_description;
